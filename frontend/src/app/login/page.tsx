...
import { FileText, MessageSquare, Database, BarChart3, LogOut, FolderHeart } from "lucide-react"
        ...
        <header className="flex items-center justify-between border-b border-zinc-800 pb-6">
          <div>
            ...
            <p className="text-xs text-zinc-500 mt-1">
              User: <span className="text-indigo-400 font-medium">{user?.email || "user@example.com"}</span>
            </p>
          </div>
